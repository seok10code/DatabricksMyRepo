...
// MAGIC %sql
// MAGIC
// MAGIC create table mjtest (cart_id STRING,
// MAGIC items ARRAY<STRING>
// MAGIC )
...
// MAGIC %sql
// MAGIC
// MAGIC insert into mjtest values ("1", ARRAY("t", "M"))

// COMMAND ----------

// MAGIC %sql
// MAGIC
// MAGIC select cart_id, explode(items) as f from mjtest

// COMMAND ----------

// MAGIC %sql
// MAGIC
// MAGIC create table ttt2 (
// MAGIC select * from catalogtest2.default.uctest)

// COMMAND ----------

// MAGIC %sql
// MAGIC
// MAGIC desc history ttt2
...
// MAGIC INSERT OVERWRITE TABLE ttt2 SELECT * FROM catalogtest2.default.uctest;
...
spark.readStream.table("catalogtest2.default.uctest").createTempView("aaa")
