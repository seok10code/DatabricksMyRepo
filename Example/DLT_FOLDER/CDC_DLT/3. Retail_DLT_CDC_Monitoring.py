...
# MAGIC   
# MAGIC 각 DLT 파이프라인은 파이프라인에 정의된 저장소 위치에서 자체 이벤트 테이블을 나타냅니다. 이 테이블에서 우리는 무슨 일이 일어나고 있는지 그리고 그것을 통과하는 데이터의 품질을 볼 수 있습니다.
# MAGIC
...
# MAGIC %fs
# MAGIC
# MAGIC ls /home/mydir/myDB/dlt_storage/system/events
...
# MAGIC %sql 
# MAGIC CREATE TABLE IF NOT EXISTS mj2727.demo_cdc_dlt_system_event_log_raw using delta LOCATION '/home/mydir/myDB/dlt_storage/system/events';
# MAGIC select * from mj2727.demo_cdc_dlt_system_event_log_raw;
...
# MAGIC        level, 
# MAGIC        details
# MAGIC   FROM mj2727.demo_cdc_dlt_system_event_log_raw
...
# MAGIC   FROM mj2727.demo_cdc_dlt_system_event_log_raw e
# MAGIC  INNER JOIN (
